...
import com.badlogic.gdx.backends.android.surfaceview.GLSurfaceViewJellyBean;
...
public class AndroidApplication extends Activity implements Application {
	...
	protected void onPause () {
		...
		if (graphics != null && graphics.view != null) {
			...
			if (graphics.view instanceof GLSurfaceViewJellyBean) ((GLSurfaceViewJellyBean)graphics.view).onPause();
	...
	protected void onResume () {
		...
		if (graphics != null && graphics.view != null) {
			...
			if (graphics.view instanceof GLSurfaceViewJellyBean) ((GLSurfaceViewJellyBean)graphics.view).onResume();
