...
public class GLSurfaceViewJellyBean extends SurfaceView implements SurfaceHolder.Callback {
     ...
     */
    public GLSurfaceViewJellyBean(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public GLSurfaceViewJellyBean(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * {@link GLSurfaceViewJellyBean#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<GLSurfaceViewJellyBean> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            GLSurfaceViewJellyBean view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private WeakReference<GLSurfaceViewJellyBean> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<GLSurfaceViewJellyBean> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
        ...
        public void surfaceCreated() {
            synchronized(sGLThreadManager) {
                ...
                mHasSurface = true;
                mSurfaceIsBad = false; // apparently in some cases surfaceDestroyed is never called
                sGLThreadManager.notifyAll();
    ...
    private final WeakReference<GLSurfaceViewJellyBean> mThisWeakRef =
            new WeakReference<GLSurfaceViewJellyBean>(this);
